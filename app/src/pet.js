...
const BUILTIN = ['robo', 'cat', 'dog', 'slime', 'bunny', 'alien', 'intj', 'intp', 'entj', 'entp', 'infp', 'infj', 'enfj', 'enfp', 'isfj', 'istj', 'estj', 'esfj', 'estp', 'isfp', 'istp', 'esfp'];
...
const PHRASES = {
  ...
  intp: ['啊，刚才想到一个超有趣的问题', '发呆中…不，是在思考', '这个 bug 很有意思，让我研究一下', '理论上…应该能行'],
  entj: ['跟上我的节奏', '目标已定，全军出击', '效率就是生命', '这一步，将军。'],
  entp: ['哎我有个绝妙的点子！', '你确定吗？我们来辩论一下', '规则就是用来打破的', '这个好玩！让我试试'],
  infp: ['刚才那朵云好像一只猫…', '在梦里给你留了位置', '嘘——我在和月亮说话', '今天也是温柔的一天'],
  infj: ['我看得见你心里的光', '慢慢来，答案会浮出来的', '提灯的人不怕夜路', '你的疲惫，我懂'],
  enfj: ['大家跟我来！', '你比自己想象的更厉害', '篝火已经点好了，来吧', '今天也要一起加油啊'],
  enfp: ['哇这个好玩那个也好玩！', '出发！去哪都行！', '我又有新主意了！！', '跟你在一起最开心了'],
  isfj: ['水喝够了吗？', '累了就靠一会儿吧', '给你温了杯茶', '我一直在，别担心'],
  istj: ['距离整点还有三分钟', '清单已完成 7/10 项', '按规定来，不会错', '一切尽在掌握'],
  estj: ['听我口令——行动！', '执行力就是战斗力', '这件事交给我，放心', '集合！开会！'],
  esfj: ['大家相处得好我就开心', '给你留了小饼干哦', '周末聚会记得来呀', '你笑起来真好看'],
  estp: ['走！去搞点好玩的', '刺激的事情要发生了', '墨镜戴好，出发！', '赢的感觉，懂吗'],
  isfp: ['这束光的颜色真好看…', '慢慢画，不着急', '陪我去看日落吧', '刚刚的灵感，画下来了'],
  istp: ['拆开来就明白了', '工具顺手，天下我有', '嗯，修好了', '话不多，活不差'],
  esfp: ['灯光！音乐！到我登场了', '生活就是要闪闪发光', '来来来，一起嗨', '今天的主角是我哦'],
};
